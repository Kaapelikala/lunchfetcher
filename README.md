...
array(2) {
  ...
  array(5) {
    ["Monday"]=>
    string(30) "Beef Wellington, uunikasvikset"
    ["Tuesday"]=>
    string(41) "Kaalikääryleet, kermaperunaa, puolukkaa"
    ["Wednesday"]=>
    string(41) "Paahdettua kalkkunanrintaa, uunijuureksia"
    ["Thursday"]=>
    string(75) "Sinapilla kuorutettua paahtopaistia, paahdettuja perunoita, minttuhernettä"
    ["Friday"]=>
